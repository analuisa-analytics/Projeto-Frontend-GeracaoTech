    ...
    <div className="flex flex-col lg:flex-row gap-8 px-4 sm:px-6 md:px-10 py-6 w-full">
      ...
      <div className="lg:hidden mb-4">
        <button
          ...
          className="px-4 py-2 bg-pink-700 text-white rounded font-semibold"
        >
          {mobileFilterOpen ? 'Fechar filtros' : 'Filtrar'}
        </button>
      </div>

      <aside className="w-full lg:w-[280px] flex-shrink-0 p-4 bg-white
    ${mobileFilterOpen ? 'block mb-4' : 'hidden lg:block'}">
